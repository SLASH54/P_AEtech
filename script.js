...
// 4. LA FUNCIÓN MÁGICA (Ahora sí es global)
    ...
    try {
        ...
        if (permission === "granted") {
            ...
            if (tokenFCM) {
                ...
                const response = await fetch(`${API_BASE_URL}/users/me/fcm-token`, {
                    method: "POST",
                    headers: {
        ...
        console.error("⚠️ Error en push:", err);
        alert("Error al activar notificaciones. Intenta desde Safari en iOS.");
    }
}
...
messaging.onMessage((payload) => {
    ...
    // Mostrar notificación nativa si el navegador lo permite
